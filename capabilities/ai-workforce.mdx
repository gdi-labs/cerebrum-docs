...
- **The right tool for the work.** Free models handle classification and verification fast and cheap. Paid models earn their cost only on the hard problems. Amos decides per step.
