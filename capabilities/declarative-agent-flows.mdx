...
description: 'Cerebrum runs every paid job through a scenario: a versioned YAML file
  that describes the agent flow as a DAG of levels. Adding a new flow is a PR that
  touches knowledge-hub/scenarios/; no worker deploy is required once the underlying
  pr...'
---
