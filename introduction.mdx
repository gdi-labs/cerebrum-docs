---
title: Cerebrum
description: Cerebrum is a queue-first AI orchestration platform from GDI Labs. It
  runs a multi-agent hierarchy against free and paid models, augmented by a retrieval-grounded
  knowledge hub, with full audit trails and per-project workspace provisioning.
---
